...
import com.cairohat.adapters.ViewPagerSimpleAdapter;
import com.cairohat.app.App;
import com.cairohat.constant.ConstantValues;
import com.cairohat.models.banner_model.BannerDetails;
...
public class HomePage_2 extends Fragment implements BaseSliderView.OnSliderClickListener {
    ...
    private void setupCustomTabs() {
        ...
        for (int i=0;  i < allSubCategoriesList.size();  i++) {
            ...
            Glide.with(this).load(ConstantValues.URL+allSubCategoriesList.get(i).getIcon()).asBitmap().into(tabIcon2);
        ...
        for (int i=0;  i< bannerImages.size();  i++) {
            ...
            slider_covers.put
                    (
                            ...
                            ConstantValues.URL+bannerDetails.getImage()
                    );
        }
