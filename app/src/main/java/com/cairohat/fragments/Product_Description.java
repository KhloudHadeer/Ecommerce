...
import com.cairohat.adapters.ProductAttributesAdapter;
...
import com.cairohat.models.product_model.Attribute;
...
//                        );
    ...
    private void ImageSlider(String itemThumbnail, List<Image> itemImages) {
        ...
        if (itemThumbnail.equalsIgnoreCase("")) {
            ...
            slider_covers.put("a", ConstantValues.URL+itemThumbnail);

        } else {
            slider_covers.put("a", ConstantValues.URL+itemThumbnail);

            for (int i=0;  i<images.length;  i++) {
                slider_covers.put("b"+i, ConstantValues.URL+images[i]);
            }
        }
