...
import com.cairohat.fragments.NewsDescription;
import com.cairohat.models.news_model.all_news.NewsDetails;
...
public class NewsListAdapter extends RecyclerView.Adapter<NewsListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        Glide
            .with(context)
            .load(ConstantValues.URL+newsDetails.getNewsImage())
