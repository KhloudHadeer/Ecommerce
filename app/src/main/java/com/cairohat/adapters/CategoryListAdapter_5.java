...
import com.cairohat.fragments.SubCategories_5;
...
public class CategoryListAdapter_5 extends RecyclerView.Adapter<CategoryListAdapter_5.MyViewHolder> {
    ...
    public CategoryListAdapter_5(Context context, List<CategoryData> categoriesList, boolean isSubCategory) {
...
//        Glide.with(context)
//                .load(ConstantValues.URL+categoryDetails.getImage())
