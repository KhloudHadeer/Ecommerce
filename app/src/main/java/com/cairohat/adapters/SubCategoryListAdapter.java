...
public class SubCategoryListAdapter extends BaseAdapter {
    ...
    Context context;
    private List<CategoryData> subCategoriesList;
    
    private LayoutInflater layoutInflater;


    public SubCategoryListAdapter(Context context, List<CategoryData> subCategoriesList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.sub_category_products.setText("total product"/*subCategoriesList.get(position).getTotalProducts() + " "+ context.getString(R.string.products)*/);

//        Glide.with(context)
//                .load(ConstantValues.URL+subCategoriesList.get(position).getImage())
