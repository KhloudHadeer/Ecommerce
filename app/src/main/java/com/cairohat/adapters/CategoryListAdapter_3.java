...
import com.cairohat.fragments.SubCategories_3;
...
public class CategoryListAdapter_3 extends RecyclerView.Adapter<CategoryListAdapter_3.MyViewHolder> {
    ...
    public CategoryListAdapter_3(Context context, List<CategoryData> categoriesList, boolean isSubCategory) {
...
//        Glide.with(context)
//                .load(ConstantValues.URL+categoryDetails.getIcon())
