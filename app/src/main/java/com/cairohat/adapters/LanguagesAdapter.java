...
import com.cairohat.models.language_model.LanguageDetails;
...
public class LanguagesAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(context).load(ConstantValues.URL+ languagesList.get(position).getImage()).into(holder.languageIcon);
