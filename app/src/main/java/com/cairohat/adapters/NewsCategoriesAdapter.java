...
import com.cairohat.fragments.News_of_Category;
import com.cairohat.models.news_model.news_categories.NewsCategoryDetails;
...
public class NewsCategoriesAdapter extends RecyclerView.Adapter<NewsCategoriesAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        Glide
            .with(context)
            .load(ConstantValues.URL+newsCategory.getImage())
